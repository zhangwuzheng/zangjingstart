...
// Using a consistent thin stroke for a high-end luxury feel
const strokeWidth = 1;
...
export const MountainIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M14.5 15.5 10 8" />
    <path d="m6.5 14 3.5-3.5" />
  </svg>
);
...
export const LeafIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M12 12c.5-1 2.5-1.5 4-1" />
  </svg>
);
...
export const BrushIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M7.07 14.94c-1.66 0-3 1.35-3 3.02 0 1.33-2.5 1.52-2.5 2.24 0 .46.62.8.62.8h.04c.75 0 .96-1.56 2.6-2.14 1.35-.47 1.94-1.92 1.94-3.61 0-.11.23-.21.3-.31Z" />
    <path d="M14 13c-2.5 0-4.7.7-6.2 2" />
  </svg>
);
...
export const AppleIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M17.5 19.1c-1.3 1.8-2.6 3.6-4.6 3.6-1.9.1-2.4-1.1-4.6-1.1-2.1 0-2.8 1.1-4.6 1.1-1.8-.1-3.3-1.8-4.5-3.6-2.5-3.5-2.1-9.9 2-9.9 1.7 0 2.8 1.1 3.7 1.1.9 0 2.5-1.3 4.4-1.3 1.4 0 2.6.7 3.2 1.6-2.8 1.6-2.3 5.7.3 6.9-.6 1.3-1.3 2.7-2 3.8h.1L17.5 19.1zM14.7 6.8c.8-.9 1.3-2.2 1.2-3.4-1.1.1-2.4.7-3.2 1.6-.7.8-1.3 2.1-1.1 3.3 1.2.1 2.3-.6 3.1-1.5z"/>
  </svg>
);

export const UserStarIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" className={className}>
